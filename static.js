...
window['bubble_run_derived']['{"function_name":"PageByName","args":[]}'] = {
    "404": {
        "id": "AAU",
        "_path": "%p3.AAX"
    },
    ...
    "badge_and_leaderboard": {
        "id": "bTHDf",
        "_path": "%p3.bTHDg"
    }
}
window.preloaded['app/derived:{"function_name":"PageByName","args":[]}'] = true;
window['bubble_run_derived']['{"function_name":"CustomByName","args":[]}'] = {}
...
window['bubble_run_derived']['{"function_name":"DefaultValues","args":[]}'] = {
    "badge": [{
        "name": "module_custom_trainingmodule",
        "value": "custom.trainingmodule",
        "display": "module",
        "deleted": null
    }, {
        "name": "name_text",
    ...
    "device": [{
        ...
        "display": "Push notification token",
        "value": "text",
...
window['bubble_run_derived']['{"function_name":"APIWFByName","args":[true]}'] = {}
window.preloaded['app/derived:{"function_name":"APIWFByName","args":[true]}'] = true;
